...
Malware Campaign Runner "Sergei" | Sergei exploits a known vulnerability on one of the JavaScript libraries used by EasyShoppe and injects a malicious script that forces users to download ransomware when they visit the site.
...
There are probably many other threat actors as well! Who else do you think could harm EasyShoppe's security on purpose or by accident?
